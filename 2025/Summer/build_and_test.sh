...
echo "  ./build_bot_version.sh              # Build new timestamped version"
...
echo "  2. Run ./build_bot_version.sh to create new version"
echo "  3. Run ./bin/real_water_fight_tester to test with REAL game mechanics"
echo ""
echo "🚀 FEATURES:"
